...
{
    {.control_size = 3, .control = {0x01, 0x10, 0x00}, .control_flag = 0, .tail_size = 8, .tail = {0x06, 0xbb, 0x22, 0x05, 0x0a, 0x00, 0xbb, 0x22}},
    {.control_size = 3, .control = {0x03, 0x0c, 0x00}, .control_flag = 0, .tail_size = 0, .tail = {0}},
    {.control_size = 3, .control = {0x03, 0x10, 0x00}, .control_flag = 0, .tail_size = 8, .tail = {0xff, 0xff, 0x8f, 0xfe, 0xdb, 0xff, 0x5b, 0x87}},
    {.control_size = 3, .control = {0x09, 0x10, 0x00}, .control_flag = 0, .tail_size = 6, .tail = {0x13, 0x71, 0xda, 0x7d, 0x1a, 0x00}},
    {.control_size = 3, .control = {0x05, 0x10, 0x00}, .control_flag = 0, .tail_size = 7, .tail = {0x36, 0x01, 0x40, 0x0a, 0x00, 0x08, 0x00}},
    {.control_size = 3, .control = {0x23, 0x0c, 0x00}, .control_flag = 0, .tail_size = 3, .tail = {0x00, 0x00, 0x00}},
    {.control_size = 3, .control = {0x14, 0x0c, 0x00}, .control_flag = 0, .tail_size = 248, .tail = {'B' , 'T' , ' ' , 'U' , 'S' , 'B' , ' ' , 'T' ,
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
    {.control_size = 3, .control = {0x25, 0x0c, 0x00}, .control_flag = 0, .tail_size = 3, .tail = {0x00, 0x60, 0x00}},
    {.control_size = 3, .control = {0x38, 0x0c, 0x00}, .control_flag = 0, .tail_size = 2, .tail = {0x00, 0x62}},
    {.control_size = 3, .control = {0x39, 0x0c, 0x00}, .control_flag = 0, .tail_size = 4, .tail = {0x01, 0x33, 0x8b, 0x9e}},
    {.control_size = 2, .control = {0x05, 0x0c}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 2, .control = {0x16, 0x0c}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 3, .control = {0x02, 0x20, 0x00}, .control_flag = 0, .tail_size = 3, .tail = {0x00, 0x00, 0x00}},
    {.control_size = 3, .control = {0x03, 0x20, 0x00}, .control_flag = 0, .tail_size = 8, .tail = {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
    {.control_size = 3, .control = {0x1c, 0x20, 0x00}, .control_flag = 0, .tail_size = 8, .tail = {0xff, 0xff, 0xff, 0x1f, 0x00, 0x00, 0x00, 0x00}},
    ...
    {.control_size = 2, .control = {0x52, 0x0c}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 2, .control = {0x45, 0x0c}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 3, .control = {0x58, 0x0c, 0x00}, .control_flag = 0, .tail_size = 1, .tail = {0x04}},
    {.control_size = 4, .control = {0x04, 0x10, 0x01, 0x01}, .control_flag = 2, .tail_size = 13, .tail = {0x04, 0x10, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 
        0x00, 0x00, 0x00, 0x00, 0x00}},
    {.control_size = 2, .control = {0x01, 0x0c}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 10, .control = {0x0d, 0x0c, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01}, .control_flag = 2, .tail_size = 7, .tail = {0x0d, 0x0c, 0x00, 0x10, 0x00, 0x00, 0x00}},
    {.control_size = 2, .control = {0x0f, 0x08}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 3, .control = {0x1b, 0x0c, 0x00}, .control_flag = 0, .tail_size = 4, .tail = {0x00, 0x08, 0x12, 0x00}},
    {.control_size = 3, .control = {0x46, 0x0c, 0x00}, .control_flag = 0, .tail_size = 1, .tail = {0x00}},
    {.control_size = 2, .control = {0x01, 0x20}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 3, .control = {0x07, 0x20, 0x00}, .control_flag = 0, .tail_size = 1, .tail = {0x00}},
    {.control_size = 3, .control = {0x0f, 0x20, 0x00}, .control_flag = 0, .tail_size = 1, .tail = {0x19}},
    {.control_size = 3, .control = {0x10, 0x20, 0x00}, .control_flag = 0, .tail_size = 1, .tail = {0x00}},
    {.control_size = 10, .control = {0x12, 0x0c,  0x07, 0x00, 0x00, 0x00, 0x00, 0x00,  0x00, 0x01}, .control_flag = 2, .tail_size = 5, .tail = {0x12, 0x0c, 0x00, 0x00, 0x00}},
    {.control_size = 2, .control = {0x56, 0x0c}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 2, .control = {0x6d, 0x0c}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 2, .control = {0x08, 0x20}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 2, .control = {0x09, 0x20}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 2, .control = {0x13, 0x0c}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 2, .control = {0x24, 0x0c}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 2, .control = {0x1a, 0x0c}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 2, .control = {0x3a, 0x0c}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 2, .control = {0x05, 0x20}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 2, .control = {0x0b, 0x20}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 2, .control = {0x0c, 0x20}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 8, .control = {0x01, 0x04, 0x05, 0x33, 0x8b, 0x9e, 0x08, 0x00}, .control_flag = 3, .tail_size = 6, .tail = {0x0f, 0x04, 0x00, 0x01, 0x01, 0x04}},
    {.control_size = 3, .control = {0x02, 0x04, 0x00}, .control_flag = 0, .tail_size = 0, .tail = {0}},
    {.control_size = 2, .control = {0x11, 0x20}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 2, .control = {0x29, 0x04}, .control_flag = 1, .tail_size = 1, .tail = {0x00}},
    {.control_size = 0, .control = {0}, .tail_size = 0, .tail = {0}}
};
